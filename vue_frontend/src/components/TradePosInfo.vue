...
const tams_url = `${backend_host}/api/main/allpostradeinfo`
...
<template>
    ...
    <el-row>
        <el-col>
            <el-table :data="tableData" row-key="id" border :tree-props="{ children: 'closePosInfos' }" stripe
                style="width: 100%;" height="1000">
                <el-table-column fixed sortable prop="symbol" label="合约" width="140">
                </el-table-column>
