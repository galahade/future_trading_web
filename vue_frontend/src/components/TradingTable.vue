...
const tams_url = `${backend_host}/api/main/trading`
    ...
    <el-row>
        <el-col>
            <el-table :data="tableData" stripe style="width: 100%;" height="1000">
                <el-table-column fixed sortable prop="symbol" label="合约" width="150">
                </el-table-column>
                ...
                <el-table-column align="center" label="交易信息">
                    <el-table-column sortable prop="trade_data.datetime" align="center" label="成交时间" width="110" />
                    <el-table-column prop="trade_data.pos" align="right" label="成交手数" width="90" />
                    <el-table-column prop="trade_data.price" align="right" label="成交价格" :formatter="priceFormatter"
                        width="100" />
                    <el-table-column prop="trade_data.slp" align="right" label="止损价" :formatter="priceFormatter"
                        width="100" />
                    <el-table-column prop="trade_data.spp" align="right" label="止盈起始价" :formatter="priceFormatter"
                        width="100" />
                    <el-table-column prop="trade_data.commission" align="right" label="手续费" :formatter="priceFormatter"
                        width="100" />
                </el-table-column>
            </el-table>
        </el-col>
